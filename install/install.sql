...
INSERT INTO `bbs_session` (`sid`, `uid`, `fid`, `url`, `ip`, `useragent`, `data`, `bigdata`, `last_date`) VALUES
    ('4bbaa1c38ba30ca58f69a6abcb89af0f', 5002372, 8, '?forum-8.htm', 32120615, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36', '', 0, 1675669574);
