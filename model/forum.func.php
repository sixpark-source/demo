...
function forum_read($fid) {
	$forum_list = forum_list_access_filter([],0);
    return $forum_list[$fid];
}
...
function forum_list_access_filter($forumlist, $gid, $allow = 'allowread') {
    ...
    $forumlist_show = [];
    foreach($bbs_list['bbslist'] as $item)
    {
        $forum = [];
        $forum['fid'] = $item['bbsid'];
        $forum['name'] = $item['sitename'];
        $forum['rank'] = '0';
        $forum['threads'] = '0';
        $forum['todayposts'] = '0';
        ...
        $forum['seo_title'] = '';
        $forum['seo_keywords'] = '';
        $forum['create_date_fmt'] = '1970-1-1';
